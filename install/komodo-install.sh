...
mkdir -p /opt/komodo
cd /opt/komodo
wget -q "https://raw.githubusercontent.com/moghtech/komodo/main/compose/$DB_COMPOSE_FILE"


msg_info "Setup Komodo Environment"
wget -q -O /opt/komodo/compose.env https://raw.githubusercontent.com/moghtech/komodo/main/compose/compose.env
